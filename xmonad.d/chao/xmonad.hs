...
myXmonadBar = "dzen2 -x '0' -y '0' -h '24' -w '1280' -ta 'l' -fg '#FFFFFF' -bg '#1B1D1E'"

myStatusBar = "conky -c ~/.xmonad/conky_dzen | dzen2 -x '3201' -w '1024' -h '24' -ta 'r' -bg '#1B1D1E' -fg '#FFFFFF' -y '0'"
 
main :: IO ()
main = do
    startApps <- spawn "sh ~/.xmonad/xmonad_scripts/startup.sh"
    composekey_set <- spawn "/usr/bin/xmodmap  ~/.xmonad/xmonad_scripts/.xmodmap"
